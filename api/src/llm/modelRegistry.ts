...
const MODEL_PROVIDER_MAP: Record<string, string> = {
  ...
  "openrouter/~anthropic/claude-opus-latest": "openrouter",
...
const MODEL_TOKEN_COST_USD: Record<string, { inputPer1K: number; outputPer1K: number }> = {
  ...
  "openrouter/~anthropic/claude-opus-latest": { inputPer1K: 0.005, outputPer1K: 0.025 },
  "openrouter/anthropic/claude-opus-4.7": { inputPer1K: 0.005, outputPer1K: 0.025 },
